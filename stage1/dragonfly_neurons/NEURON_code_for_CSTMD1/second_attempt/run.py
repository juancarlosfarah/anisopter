...
call(["python", "example.py", "-file", "64x64_weak_closer_200.pkl", "-K", str(K), "-Na", str(Na)])
with open("data.pkl", 'rb') as my_file :
    data_weak = pickle.load(my_file)

call(["python", "example.py", "-file", "64x64_diag_200.pkl", "-K", str(K), "-Na", str(Na)])
with open("data.pkl", 'rb') as my_file :
    data_diag = pickle.load(my_file)

call(["python", "example.py", "-file", "64x64_3_targets_200.pkl", "-K", str(K), "-Na", str(Na)])
with open("data.pkl", 'rb') as my_file :
    data_3 = pickle.load(my_file)
...
real_fr_3 = real_firing_rates(data_3)
