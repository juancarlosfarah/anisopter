...
-       id = self.id_vec
    ...
    def plot(self) :     
        ...
        if self.plot_activity :
            ...
            exec "plt.subplot("+str(self.num_neurons)+","+str(self.electrodes+1)+","+str(self.electrodes+1)+")"
            ...
            # FIRING RATE
            exec "plt.subplot("+str(self.num_neurons)+","+str(self.electrodes+1)+","+str(2*self.electrodes+2)+")"
            a = plt.gca()
            a.set_xlim([0,self.t_stop])
