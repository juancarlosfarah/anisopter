...
<div class="container">
    ...
    <form action="/estmd/simulation/run" method="post">
        ...
        <div class="form-group optional">
            <p class="help-block">
                To modify the advanced parameters below, reference
                should be made to the following paper, from which the
                implementation is taken:
            </p>
            <p class="help-block">
                <a href="http://www.researchgate.net/profile/Ben_Cazzolato/publication/233815971_Discrete_implementation_of_biologically_inspired_image_processing_for_target_detection/links/00b7d52d3699b6aa90000000.pdf"
                   target="_blank">Discrete implementation of biologically
                    inspired image processing for target detection</a></p>
	    <p class="help-block">
            The H filter is the convolution applied in the photoreceptors:
        </p>
        ...
        <div class="form-group optional">
            <p class="help-block">Below, a and b correspond to the numerator and
                denominator of the first z-transform:</p>
            <label for="b">b</label>
        ...
        <div class="form-group optional">
            <p class="help-block">CSKernel corresponds to the convolution
                applied in the RTC cell:</p>
        ...
        <div class="form-group optional">
            <p class="help-block">Below, a1 and b1 correspond to the numerator
                and denominator of the final z-transform.</p>
